...
/**
 * EzConfigImportCommands.
 */
class EzConfigImportCommands extends DrushCommands {
  ...
  public function import($label = NULL, $options = [
    ...
    $environment_dir = $environment->get('config');
    ...
    $config = new FileStorage($environment->get('config'));
    $environment_storage = new StorageReplaceDataWrapper($config);
    $replacement_storage = new StorageReplaceDataWrapper($active_storage);
    foreach ($source_storage->listAll() as $name) {
      $data = $source_storage->read($name);
      if ($env_data = $environment_storage->read($name)) {
        $data = $env_data;
      }
